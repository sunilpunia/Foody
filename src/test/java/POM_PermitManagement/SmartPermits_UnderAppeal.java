...
public class SmartPermits_UnderAppeal {

	
	public WebDriver driver;

	public SmartPermits_UnderAppeal(WebDriver sdriver) {
		this.driver = sdriver;
	}
	...
	@FindBy(how=How.XPATH,using="//select[@id='ddlStatusId']/option[9]")
